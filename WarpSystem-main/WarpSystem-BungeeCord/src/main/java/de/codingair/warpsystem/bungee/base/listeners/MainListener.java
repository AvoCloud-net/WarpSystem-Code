...
public class MainListener implements Listener {
    ...
    public MainListener() {
        WarpSystem.getDataHandler().registerHandler(MessagePacket.class, new MessagePacketHandler());
        WarpSystem.getDataHandler().registerHandler(PrepareServerSwitchPacket.class, new PrepareServerSwitchPacketHandler());
        WarpSystem.getDataHandler().registerHandler(RequestFullNamePacket.class, new RequestFullNamePacketHandler());
        WarpSystem.getDataHandler().registerHandler(RequestInitialPacket.class, new RequestInitialPacketHandler());
        WarpSystem.getDataHandler().registerHandler(RequestServerStatusPacket.class, new RequestServerStatusPacketHandler());
    }
