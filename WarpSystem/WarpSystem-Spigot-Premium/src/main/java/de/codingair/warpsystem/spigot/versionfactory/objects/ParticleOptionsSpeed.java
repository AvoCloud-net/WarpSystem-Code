...
public class ParticleOptionsSpeed implements ItemListener {
    private final ParticleOptions instance;

    public ParticleOptionsSpeed(ParticleOptions instance) {
    ...
    public void onHover(HotbarGUI gui, ItemComponent old, ItemComponent current, Player player) {
        MessageAPI.sendActionBar(instance.getPlayer(), AnimationHotBarEditor.MINUS_PLUS(Lang.get("Animation_Speed")), WarpSystem.getInstance(), Integer.MAX_VALUE);
    }
