...
public class VelocityConfigMask implements DataMask {
    ...
    public VelocityConfigMask(Map<?, ?> map) {
        this(new Configuration(map));
    }

    public VelocityConfigMask(Configuration root) {
        this(root, null);
    }

    public VelocityConfigMask(Configuration root, String prefix) {
        this.root = root;
        this.prefix = prefix == null ? "" : prefix;
        this.file = null;
    }

    public VelocityConfigMask(ConfigFile file) {
        this(file, null);
    }

    public VelocityConfigMask(ConfigFile file, String prefix) {
        this.file = file;
        this.prefix = prefix == null ? "" : prefix;
