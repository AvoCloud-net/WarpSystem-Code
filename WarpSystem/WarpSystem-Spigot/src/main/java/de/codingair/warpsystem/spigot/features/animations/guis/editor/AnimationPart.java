...
public class AnimationPart extends HotbarGUI {
    ...
    public void initialize() {
        ...
        setItem(4, new ItemComponent(new ItemBuilder(XMaterial.CYAN_DYE).setName("§7" + Lang.get("Color") + ": §e" + (getColor() == null || !getPart().getParticle().isColorable() ? "§c-" : getColorName())).getItem(), VFac.build(ItemListener.class, VKey.AnimationPartColor, AnimationPart.this)));
        ...
        setItem(7, VFac.build(ItemComponent.class, VKey.RotationItemComponent, this.rotation), false);

        setItem(8, new ItemComponent(new ItemBuilder(XMaterial.SUGAR).setName("§7" + Lang.get("Animation_Speed") + ": §e" + getSpeed()).getItem(), VFac.build(ItemListener.class, VKey.AnimationPartColor, AnimationPart.this)));
