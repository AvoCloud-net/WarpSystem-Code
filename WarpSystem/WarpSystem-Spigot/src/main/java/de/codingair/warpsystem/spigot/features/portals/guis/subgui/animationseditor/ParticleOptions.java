...
public class ParticleOptions extends HotbarGUI {
    ...
    public void initialize() {
        ...
        setItem(5, new ItemComponent(new ItemBuilder(XMaterial.SUGAR).setName("§7" + Lang.get("Animation_Speed") + ": §e" + getSpeed()).getItem(), VFac.build(ItemListener.class, VKey.ParticleOptionsSpeed, ParticleOptions.this)));

        setItem(6, new ItemComponent(new ItemBuilder(XMaterial.CYAN_DYE).setName("§7" + Lang.get("Color") + ": §e" + (getColor() == null || !getPart().getParticle().isColorable() ? "§c-" : getColorName())).getItem(), VFac.build(ItemListener.class, VKey.ParticleOptionsColor, ParticleOptions.this)));
    }
    ...
    public AnimationHotBarEditor getMain() {
        return main;
    }
}
