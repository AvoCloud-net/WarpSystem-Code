...
public class GChooseIconType extends GUI {
    ...
    public void initialize(Player p) {
        ...
        addButton(VFac.build(ItemButton.class, VKey.WarpGUIChoosePage, this, 6, new ItemBuilder(Material.CHEST).setName("§c" + Lang.get("Page")).getItem()).setOption(option));
    }
